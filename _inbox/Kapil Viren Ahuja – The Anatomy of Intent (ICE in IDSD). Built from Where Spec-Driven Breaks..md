...
- **L'Intent est la seule partie irréductible à l'humain** : le harness gère le Context, les Expectations peuvent être générées — mais l'Intent reste la responsabilité que personne d'autre, humain ou machine, ne peut assumer à ta place.
...
**Source :** [The Anatomy of Intent (ICE in IDSD). Built from Where Spec-Driven Breaks.](https://medium.com/activated-thinker/the-anatomy-of-intent-ice-in-idsd-built-from-where-spec-driven-breaks-1597e5a16659)  
**Auteur :** Kapil Viren Ahuja  
**Clipé le :** 2026-05-31T12:15:51+02:00
